    ...
    entrypoints: [
        ...
        },
        {
            ...
            alias: {
                ...
                'assert': false,
                'global': resolve(ROOT, './src/global/index.js'),
                'react': resolve(ROOT, './src/ui/react.js'),
                'react-dom': resolve(ROOT, './src/ui/react-dom.js'),
                '@storybook/api': resolve(ROOT, './src/ui/api.js'),
                '@storybook/addons': resolve(ROOT, './src/ui/addons.js'),
                '@storybook/channels': resolve(ROOT, './src/ui/channels.js'),
                '@storybook/client-logger': resolve(ROOT, './src/ui/client-logger.js'),
                '@storybook/components': resolve(ROOT, './src/ui/components.js'),
                '@storybook/core-events': resolve(ROOT, './src/ui/core-events.js'),
                '@storybook/router': resolve(ROOT, './src/ui/router.js'),
                '@storybook/theming': resolve(ROOT, './src/ui/theming.js'),
            },
            output: './dist/',
        },
    ],
