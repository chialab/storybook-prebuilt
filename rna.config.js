    ...
    entrypoints: [
        {
            input: [
                ...
                './src/addons/a11y/a11y.js',
                './src/addons/a11y/a11y.manager.js',
                './src/addons/actions/actions.js',
                './src/addons/backgrounds/backgrounds.js',
                './src/addons/backgrounds/backgrounds.manager.js',
                './src/addons/controls/controls.manager.js',
                './src/addons/measure/measure.js',
                './src/addons/measure/measure.manager.js',
                './src/addons/outline/outline.js',
                './src/addons/outline/outline.manager.js',
                './src/addons/toolbars/toolbars.manager.js',
                './src/addons/viewport/viewport.manager.js',
                './src/addons/essentials/essentials.js',
                './src/addons/essentials/essentials.manager.js',
                './src/addons/links/links.js',
                './src/addons/links/links.manager.js',
                './src/addons/links/links.react.js',
            ...
            alias: {
                ...
                '@storybook/addon-a11y': resolve(ROOT, './src/addons/a11y/a11y.js'),
                '@storybook/addon-actions': resolve(ROOT, './src/addons/actions/actions.js'),
                '@storybook/addon-backgrounds': resolve(ROOT, './src/addons/backgrounds/backgrounds.js'),
                '@storybook/addon-links': resolve(ROOT, './src/addons/links/links.js'),
                '@storybook/addon-links/react': resolve(ROOT, './src/addons/links/links.react.js'),
                '@storybook/addon-measure': resolve(ROOT, './src/addons/measure/links.js'),
                '@storybook/addon-outline': resolve(ROOT, './src/addons/outline/links.js'),
                '@storybook/essentials': resolve(ROOT, './src/addons/essentials/essentials.js'),
